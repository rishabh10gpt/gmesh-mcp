...
async def main():
    parser = argparse.ArgumentParser(description="Generate meshes using natural language descriptions")
    parser.add_argument("prompt", help="Description of the mesh to generate")
    parser.add_argument("--provider", choices=["ollama", "anthropic", "openai"], default="ollama",
                      help="LLM provider to use")
    parser.add_argument("--model", help="Model name to use", default=OLLAMA_MODEL_NAME)
